    ...
    return (
        <div className={`w-full border border-gray-200 rounded-lg shadow `}>
            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className={`text-xl font-semibold tracking-tight ${themeMode === "light" ? "text-gray-900" : "text-white"}`}>
                ...
                <div className="flex items-center justify-between">
                    <span className={`text-3xl font-bold ${themeMode === "light" ? "text-gray-900" : "text-white"}`}>$599</span>
                    <a
                        href="/"
